-- Mesmo conteúdo de sqlserver.sql (SQL Server + dados de exemplo).
-- Execute no SSMS ou Azure Data Studio.
...
('Creatina'), ('Whey'), ('Pré-treino'), ('Energético'), ('Diurético'),
('Barrinha proteica'), ('Carb Up'), ('Cafeína'), ('Aminoácidos'), ('Termogênico');
...
(21, 'Moto Honda CG 160'), (22, 'Moto Yamaha YBR'), (23, 'Bicicleta Elétrica'),
(24, 'Carro Fiat Uno'), (25, 'Moto Honda Biz'), (26, 'Moto Yamaha NMAX'),
(27, 'Bicicleta Convencional'), (28, 'Moto Honda Bros'), (29, 'Patinete Elétrico'),
(30, 'Carro VW Gol');
...
(1, 1, 45.90, 1), (1, 4, 12.00, 1), (2, 2, 89.90, 1), (3, 7, 28.00, 1), (3, 3, 9.00, 1),
(5, 8, 65.00, 1), (5, 5, 15.00, 1), (6, 1, 45.90, 1), (7, 7, 28.00, 1), (8, 8, 65.00, 1),
(9, 10, 29.90, 1), (9, 4, 12.00, 1), (10, 10, 29.90, 1);
