...
public class frmpesquisarproduto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        TBProduto.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Descrição", "Estoque", "Status", "Preço", "Categoria"
            }
        ) {
        ...
        try {
            ...
            for (int num = 0; num < lista.size(); num++) {
                model.addRow(new Object[]{
                    ...
                    lista.get(num).getCodigoCategoria()
                });
            }
        } catch (Exception e) {
    ...
    private void CarregarCamposProduto() {
        ...
        frmproduto.txtid.setText(valorCelula(setar, 0));
        frmproduto.txtdescricao.setText(valorCelula(setar, 1));
        frmproduto.txtestoque.setText(valorCelula(setar, 2));
        frmproduto.cbstatus.setSelectedItem(valorCelula(setar, 3));
        frmproduto.txtpreco.setText(valorCelula(setar, 4));
        frmproduto.txtcategoria.setText(valorCelula(setar, 5));
        this.dispose();
    }

    private String valorCelula(int linha, int coluna) {
        Object valor = TBProduto.getModel().getValueAt(linha, coluna);
